...
namespace CFTraining.DataStructures
{
    ...
    public class SumSegmentTree
    {
        ...
        private long QuerySum(int ql, int qr, int l, int r, int pos)
        {
            if (l > r) return 0;
        ...
        {
            Update(index, 0, _original.Length - 1, 0, value);
        }
        private void Update(int index, int l, int r, int pos, int value)
        {
            ...
            else if (index < l || index > r) return;
            else
            {
                int mid = (l + r) / 2;
                Update(index, l, mid, pos * 2 + 1, value);
                Update(index, mid + 1, r, pos * 2 + 2, value);
                _tree[pos] = _tree[pos * 2 + 1] + _tree[pos * 2 + 2];
            }
        }
    }
